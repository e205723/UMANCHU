...
class UserInterface():
    ...
    def update(self):
        self.layers = [
            Layer(self,"package/TILES/MAP.png",self.view,self.view.ground),
            Layer(self,"package/TILES/UNIT.png",self.view,self.view.units),
            Layer(self,"package/TILES/ARROW.png",self.view,self.view.arrow),
            Layer(self,"package/TILES/BACKGROUND.png",self.view,self.view.menuBackGround),
            Layer(self,"package/TILES/LETTER.png",self.view,self.view.menu),
            Layer(self,"package/TILES/BACKGROUND.png",self.view,self.view.logBackGround),
            Layer(self,"package/TILES/LETTER.png",self.view,self.view.log),
            Layer(self,"package/TILES/BACKGROUND.png",self.view,self.view.selectBackGround),
            Layer(self,"package/TILES/LETTER.png",self.view,self.view.select),
            Layer(self,"package/TILES/BACKGROUND.png",self.view,self.view.headerBackGround),
            Layer(self,"package/TILES/LETTER.png",self.view,self.view.header),
            Layer(self,"package/TILES/BACKGROUND.png",self.view,self.view.topBackGround),
            Layer(self,"package/TILES/LETTER.png",self.view,self.view.top),
            Layer(self,"package/TILES/BACKGROUND.png",self.view,self.view.darken),
            Layer(self,"package/TILES/BACKGROUND.png",self.view,self.view.messageBackGround),
            Layer(self,"package/TILES/LETTER.png",self.view,self.view.message)
        ]

    def playMusic(self):
        pygame.mixer.music.load("package/MUSIC/theme.mp3") #読み込み
